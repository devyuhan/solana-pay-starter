          ...
          <div className={styles.form_container}>
            ...
            <div className={styles.flex_row}>
              <input
                className={styles.input}
                type="url"
                placeholder="Image URL ex: https://img.ltwebstatic.com/images3_pi/2021/05/25/16219317936e1b5763318daee14c09ca4551e4859e_thumbnail_600x.webp"
                onChange={(e) => {
